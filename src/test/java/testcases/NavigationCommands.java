...
public class NavigationCommands {
	...
	public void  nav() throws IOException
	{
	    ...
	    FileUtils.copyFile(file, new File("G:\\Myworkspacejava\\com.codemind.project\\src\\test\\resources\\test.png"));
	    
	    
	      JavascriptExecutor javascriptExecutor=(JavascriptExecutor) driver;
	      
	      /*the scroll by the page end used by this one line code
